<div class="page-header">
	<h1>
		Agenda<br>
		<small>maintenance data agenda</small>
	</h1>
</div>
<?php
...
?>
<form class="form-inline" role="form" method="post" action="<?php echo base_url().'index.php/admin/agenda'; ?>">
	<div class="form-group">
		<div class="btn-group">
			<a href="<?php echo base_url().'index.php/agenda/tambah'; ?>" class="btn btn-default" title="Tambah Agenda">
		...
		<tbody>
			...
			if (count($agenda) > 0) {
				...
				foreach ($agenda as $value) {
					echo "<tr>";
					echo "<td>".$no."</td>";
					echo "<td>".date('d M Y', strtotime($value['tgl_agenda']))."</td>";
					echo "<td>".$value['nama_agenda']."</td>";
					echo "<td>".$value['ket_agenda']."</td>";
					echo "<td>";
					//echo anchor('agenda/detil/'.$value['id_agenda'], 
					//	'<span class="glyphicon glyphicon-eye-open"></span> Lihat', array('class'=>'btn btn-primary btn-xs'));
					//echo nbs(1);
					echo anchor('agenda/ubah_agenda/'.$value['id_agenda'], 
						'<span class="glyphicon glyphicon-edit"></span> Ubah', array('class'=>'btn btn-info btn-xs'));
					echo nbs(1);
					echo anchor('agenda/hapus/'.$value['id_agenda'], 
...
<div class="modal fade" id="modalDeleteAll" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
				<a href="<?php echo base_url().'index.php/agenda/hapus_semua'; ?>" class="btn btn-danger">Oke</a>
			</div>
		</div>
	</div>
</div>
